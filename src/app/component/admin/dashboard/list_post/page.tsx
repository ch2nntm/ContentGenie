                ...
                <div className={styles.section}>
                    <div className={styles.btn_time_group}>
                        <select onChange={(e) => setSelectedYear(Number(e.target.value))}>
                            {Array.from({ length: 10 }, (_, i) => 2020 + i).map((year) => (
                                <option key={year} value={year}>Nam {year}</option>
                            ))}
                        </select>
                    ...
                    <div className={styles.content_section}>
                        <Table className={styles.table}>
                            <TableHead>
                                <TableRow>
                                    <TableCell key={0} align="center" className={styles.tablecell}>Chu Nhat</TableCell>
                                    <TableCell key={1} align="center" className={styles.tablecell}>Thứ 2</TableCell>
                                    <TableCell key={2} align="center" className={styles.tablecell}>Thứ 3</TableCell>
                                    <TableCell key={3} align="center" className={styles.tablecell}>Thứ 4</TableCell>
                                    <TableCell key={4} align="center" className={styles.tablecell}>Thứ 5</TableCell>
                                    <TableCell key={5} align="center" className={styles.tablecell}>Thứ 6</TableCell>
                                    <TableCell key={6} align="center" className={styles.tablecell}>Thứ 7</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
